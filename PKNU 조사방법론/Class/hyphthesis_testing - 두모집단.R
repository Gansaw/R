# 두모집단 예제 1 : 된장의 다이어트 효능

##      바이오벤처 기업인 D사에서는 다이어트에 관해 괄목할만한 효과가 있는 된장을 만들었다.
##      이러한 D사의 된장이 체중감량에 탁월한 효ㅕ과가 있는지 검정하기 위하여 20명을 실험대상으로
##      선발하여 된장 섭취 전과 후의 체중변화를 살펴보았다. 그 결과 평균 2.55kg이 감량되었을을
##`     알 수 있었다. 또한 감량 무게의 표준편차는 3.13으로 측정되었다. 이러한 표본조사 결과를
##      이용하여 과연 D사의 된장이 다이어트 효과가 있다고 판단할 수 있는지를 5%의 유의수준에서
##      검정해 보시오.
...
##      A회사의 타이어와 B회사의 타이어 평균수명에 차이가 있는지를 검정하기 위하여 각 회사의
##      제품을 무작위로 30개씩 표본으로 추출하여 조사하였다 .표본조사 결과 A사에서 생산한 타이어의
##      평균수명은 48,500km이고 표준편차는 3,600km이다. 반면에 B사에서 생산한 타이어의 평균수명은
##      52,000km이고 표준편차는 4,200km이었다. 두 타이어 회사의 분산이 다르다는 전제하에서 유의수준(a)을
##      0.05로 하여 두 회사 타이어의 평균수명에 차이가 있는지를 검정하시오.
