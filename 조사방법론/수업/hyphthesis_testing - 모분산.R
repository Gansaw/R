...
##      전매청에서 제조하는 화랑담배에 포함되어 있는 니코틴은 분산이 1.2mg^2이라고 알려져 있다.
##      그러나 생산되는 시기에 따라 담배에 포함되어 있는 니코틴 함유량이 담배마다 서로 크게
##      다른 것 같다는 소비자들의 불만이 많아, 소비자 단체에서는 일주일 동안 생산된 화랑담배
##      중에서 임의로 30개를 표본으로 추출한 결과 니코틴의 분산은 1.7mg^2으로 측정되었다.
##      이러한 결과를 바탕으로 조사하여 5%를 유의수준(a)으로 하여 분산에 대한 가설검정을 실시해 보시오.
